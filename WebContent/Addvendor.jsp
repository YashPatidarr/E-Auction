...
<body ">
<form action="VendorReg" method="post">

<h1 align=center><font size="12" color ="Blue">Register New Vendor</font></h1>
...
<td><input type="text" name="slnm"></td>
</tr>
<tr>
<td>Enter Email </td>
...
<h1 align = "center" ><input type="submit" value ="Add Vendor" ></h1>
